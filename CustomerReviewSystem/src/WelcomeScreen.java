...
public class WelcomeScreen
{
	...
	public static void writeNewReview()
	{
		...
		String givenTitle = read.next();
		
		System.out.println("Enter Price: ");
		String givenPrice = read.next();
		
		System.out.println("Enter Rating: ");
		String givenRating = read.next();
		
		System.out.println("Enter Context: ");
		String dummyWord = read.next();
		String givenContext = dummyWord + " " + read.nextLine();
		
		Review newUserReview = new Review(
				givenTitle,
				givenPrice,
				givenRating,
				givenContext);
		
		reviews.add(newUserReview);
